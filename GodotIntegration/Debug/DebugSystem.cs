...
public partial class DebugSystem : Node
{
    ...
    private void InitializeLogger()
    {
        ...
        var fallbackOutput = new Darklands.Application.Infrastructure.Logging.TestConsoleOutput();
        Logger = new Darklands.Application.Infrastructure.Logging.UnifiedCategoryLogger(fallbackOutput, Config);
    }
    ...
    private void OnDebugConfigChanged(string propertyName)
    {
        if (propertyName == nameof(Config.CurrentLogLevel))
        {
            ...
            if (GameStrapper.GlobalLevelSwitch != null)
            {
                GameStrapper.GlobalLevelSwitch.MinimumLevel = serilogLevel;
