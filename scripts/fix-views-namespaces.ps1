#!/usr/bin/env pwsh
# Fix namespace references in Views folder

$ErrorActionPreference = "Stop"

Write-Host "Fixing Views namespace references..." -ForegroundColor Cyan
...
# Get all View files
$viewFiles = Get-ChildItem -Path "Views" -Filter "*.cs" -Recurse
...
Write-Host "`nViews namespace fix complete!" -ForegroundColor Green
