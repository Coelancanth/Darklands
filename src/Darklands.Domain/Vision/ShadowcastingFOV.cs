...
using GridModel = Darklands.Domain.Grid.Grid;
...
namespace Darklands.Domain.Vision
{
    ...
    public static class ShadowcastingFOV
    {
        ...
        public static Fin<ImmutableHashSet<Position>> CalculateFOV(Position origin, int range, GridModel grid)
        {
            if (range < 0)
        ...
        /// </summary>
        public static bool HasLineOfSight(Position from, Position to, GridModel grid)
        {
